...
class StateMasterPage extends StatefulWidget {
  const StateMasterPage({super.key});

  @override
  State<StateMasterPage> createState() =>
      _StateMasterPageState();
}

class _StateMasterPageState extends State<StateMasterPage> {
   Info? editingUnit;
