...
class _HomePageState extends State<HomePage> {
  ...
  final List<MenuItemData> menuItems = [
    ...
    ///sales
    MenuItemData(title: "Sales", icon: Icons.account_balance, subItems: [
      MenuItemData(
        title: "Sales POS",
        icon: Icons.shopping_basket,
          ...
          if (!isMobile)
            SideMenu(
              ...
              onItemSelected: (parent, [sub]) {
                setState(() {
                  _selectedParentIndex = parent;
                  _selectedSubIndex = sub;
                });
              },
            ),
          Expanded(
