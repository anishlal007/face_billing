...
// import 'package:facebilling/ui/widgets/custom_text_field.dart';
// import 'package:facebilling/ui/widgets/gradient_button.dart';
...
//                       hintText: "Enter Customer ID Prefix",
//                       controller: custIdPrefixController,
//                       prefixIcon: Icons.calendar_today,
//                       isValidate: true,
//                       validator: (value) => value == null || value.isEmpty
//                           ? "Enter Customer ID Prefix"
//                           : null,
//                       focusNode: finYearCodeFocus,
//                       textInputAction: TextInputAction.next,
//                       onEditingComplete: () {
...
//                     width: constraints.maxWidth / columns - 20,
//                     child: CustomTextField(
//                       title: "Customer ID Sufix",
//                       hintText: "Enter Customer ID Sufix",
//                       controller: custIdSuffixController,
//                       prefixIcon: Icons.calendar_today,
//                       isValidate: true,
//                       validator: (value) => value == null || value.isEmpty
//                           ? "Enter Customer ID Sufix"
//                           : null,
//                       focusNode: finYearCodeFocus,
//                       textInputAction: TextInputAction.next,
//                       onEditingComplete: () {
...
//                     width: constraints.maxWidth / columns - 20,
//                     child: CustomTextField(
//                       title: "Customer ID Formal Digit",
//                       hintText: "Enter Customer ID Formal Digit",
//                       controller: custIdFormalDigitController,
//                       prefixIcon: Icons.calendar_today,
//                       isValidate: true,
//                       validator: (value) => value == null || value.isEmpty
//                           ? "Enter Customer ID Formal Digit"
//                           : null,
//                       focusNode: finYearCodeFocus,
//                       textInputAction: TextInputAction.next,
//                       onEditingComplete: () {
...
//                       onEditingComplete: () {
//                         FocusScope.of(context)
//                             .requestFocus(supIdFormalDigitFocus);
//                       },
//                     ),
//                   ),
//                   const SizedBox(height: 12),
...
//                       onEditingComplete: () {
//                         FocusScope.of(context)
//                             .requestFocus(productIdPrefixFocus);
//                       },
//                     ),
//                   ),
//                   const Divider(),
...
//                       onEditingComplete: () {
//                         FocusScope.of(context)
//                             .requestFocus(purNoFormalDigitFocus);
//                       },
//                     ),
//                   ),
//                   const SizedBox(height: 12),
...
//                       onEditingComplete: () {
//                         FocusScope.of(context)
//                             .requestFocus(purNo2FormalDigitFocus);
//                       },
//                     ),
//                   ),
//                   const SizedBox(height: 20),
...
//                       onEditingComplete: () {
//                         FocusScope.of(context)
//                             .requestFocus(purOrderNoPrefixFocus);
//                       },
//                     ),
//                   ),
//                   const Divider(),
...
//                       onEditingComplete: () {
//                         FocusScope.of(context)
//                             .requestFocus(purchaseOderNoFocus);
//                       },
//                     ),
//                   ),
//                   const SizedBox(height: 20),
...
//                       onEditingComplete: () {
//                         FocusScope.of(context)
//                             .requestFocus(purOrderNoSuffixFocus);
//                       },
//                     ),
//                   ),
//                   const SizedBox(height: 20),
...
//                       onEditingComplete: () {
//                         FocusScope.of(context)
//                             .requestFocus(purOrderNo2PrefixFocus);
//                       },
//                     ),
//                   ),
//                   const SizedBox(height: 20),
...
//                       onEditingComplete: () {
//                         FocusScope.of(context)
//                             .requestFocus(purchaseOrderNo2Focus);
//                       },
//                     ),
//                   ),
//                   const SizedBox(height: 20),
...
//                       onEditingComplete: () {
//                         FocusScope.of(context)
//                             .requestFocus(purOrderNo2SuffixFocus);
//                       },
//                     ),
//                   ),
//                   const SizedBox(height: 20),
...
//                       onEditingComplete: () {
//                         FocusScope.of(context)
//                             .requestFocus(quoNoFormalDigitFocus);
//                       },
//                     ),
//                   ),
//                   const SizedBox(height: 20),
...
//                       onEditingComplete: () {
//                         FocusScope.of(context)
//                             .requestFocus(quoNo2FormalDigitFocus);
//                       },
//                     ),
//                   ),
//                   const SizedBox(height: 20),
...
//                       onEditingComplete: () {
//                         FocusScope.of(context)
//                             .requestFocus(salesNo2PrefixFocus);
//                       },
//                     ),
//                   ),
//                   const SizedBox(height: 20),
...
//                       onEditingComplete: () {
//                         FocusScope.of(context)
//                             .requestFocus(salesNo2SuffixFocus);
//                       },
//                     ),
//                   ),
//                   const SizedBox(height: 20),
