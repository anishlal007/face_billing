...
class SalesOrderEntryPage extends StatefulWidget {
  const SalesOrderEntryPage({super.key});

  @override
  State<SalesOrderEntryPage> createState() => _SalesOrderEntryPageState();
}

class _SalesOrderEntryPageState extends State<SalesOrderEntryPage> {
  Info? editingUnit;
