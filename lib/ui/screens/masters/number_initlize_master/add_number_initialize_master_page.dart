...
import '../../../../data/models/number_initialize/NumberInitializationResponse.dart';
...
class AddNumberInitializeMasterPage extends StatefulWidget {
  ...
  @override
  State<AddNumberInitializeMasterPage> createState() =>
      _AddNumberInitializeMasterPageState();
}

class _AddNumberInitializeMasterPageState
    extends State<AddNumberInitializeMasterPage> {
  final _formKey = GlobalKey<FormState>();
  final NumberInitializeService _service = NumberInitializeService();

  master.GetAllMasterListModel? getAllMasterListModel;

  NumberSerilizationResponse? serialNumbers;
...
// Controllers
  ...
  final TextEditingController custIdFormalDigitController =
  ...
  final TextEditingController supIdFormalDigitController =
      TextEditingController();
  final TextEditingController productIdPrefixController =
      TextEditingController();

  final TextEditingController productIdController = TextEditingController();
  final TextEditingController productIdFormalDigitController =
      TextEditingController();
  ...
  final TextEditingController purNoFormalDigitController =
      TextEditingController();
  ...
  final TextEditingController salesNoFormalDigitController =
      TextEditingController();
  ...
  final TextEditingController purNo2FormalDigitController =
      TextEditingController();
  final TextEditingController purOrderNoPrefixController =
      TextEditingController();
  final TextEditingController purchaseOderNoController =
      TextEditingController();
  final TextEditingController purOrderNoSuffixController =
      TextEditingController();
  final TextEditingController purOrderNoFormalDigitController =
      TextEditingController();
  final TextEditingController purOrderNo2PrefixController =
      TextEditingController();
  final TextEditingController purchaseOrderNo2Controller =
      TextEditingController();
  final TextEditingController purOrderNo2SuffixController =
      TextEditingController();
  final TextEditingController purOrderNo2FormalDigitController =
      TextEditingController();
  ...
  final TextEditingController quoNoFormalDigitController =
      TextEditingController();
  ...
  final TextEditingController quoNo2FormalDigitController =
      TextEditingController();
  final TextEditingController salesNo2PrefixController =
      TextEditingController();
  final TextEditingController salesNo2Controller = TextEditingController();
  final TextEditingController salesNo2SuffixController =
      TextEditingController();
  final TextEditingController salesNo2FormalDigitController =
      TextEditingController();

  final TextEditingController salesOrderNoPrefixController =
      TextEditingController();
  final TextEditingController salesOrderNoController = TextEditingController();
  final TextEditingController salesOrderNoFormalDigitController =
      TextEditingController();
  final TextEditingController salesOrderNoSuffixController =
      TextEditingController();
...
// FocusNodes
  ...
  Future<void> _loadSerialNo() async {
    ...
    try {
      final response = await _service.getNumberInitialize();

      if (response.isSuccess) {
        setState(() {
          if (response.data!.info!.isNotEmpty) {
            _isEditMode = true;
          }
          serialNumbers = response.data!;
          _getAllLoading = false;

          // ✅ Safe check for data before accessing .first
          final infoList = serialNumbers?.info;
          if (infoList != null && infoList.isNotEmpty) {
            final first = infoList.first;

            coCodeController.text = first.coCode ?? "";
            finYearCodeController.text = first.finYearCode ?? "";
            custIdPrefixController.text = first.custIdPrefix ?? "";
            custIdController.text = first.custId ?? "";
            custIdSuffixController.text = first.custIdSuffix ?? "";
            custIdFormalDigitController.text = first.custIdFormalDigit ?? "";
            supIdPrefixController.text = first.supIdPrefix ?? "";
            supIdController.text = first.supId ?? "";
            supIdSuffixController.text = first.supIdSuffix ?? "";
            supIdFormalDigitController.text = first.supIdFormalDigit ?? "";
            productIdPrefixController.text = first.productIdPrefix ?? "";
            productIdController.text = first.productId ?? "";
            productIdFormalDigitController.text =
                first.productIdFormalDigit ?? "";
            purNoPrefixController.text = first.purNoPrefix ?? "";
            purchaseNoController.text = first.purchaseNo ?? "";
            purNoSuffixController.text = first.purNoSuffix ?? "";
            purNoFormalDigitController.text = first.purNoFormalDigit ?? "";
            salesNoPrefixController.text = first.salesNoPrefix ?? "";
            salesNoController.text = first.salesNo ?? "";
            salesNoSuffixController.text = first.salesNoSuffix ?? "";
            salesNoFormalDigitController.text = first.salesNoFormalDigit ?? "";
            purNo2PrefixController.text = first.purNo2Prefix ?? "";
            purchaseNo2Controller.text = first.purchaseNo2 ?? "";
            purNo2SuffixController.text = first.purNo2Suffix ?? "";
            purNo2FormalDigitController.text = first.purNo2FormalDigit ?? "";
            purOrderNoPrefixController.text = first.purOrderNoPrefix ?? "";
            purchaseOderNoController.text = first.purchaseNo ?? "";
            purOrderNoSuffixController.text = first.purNoPrefix ?? "";
            purOrderNoFormalDigitController.text =
                first.purOrderNoFormalDigit ?? "";
            purOrderNo2PrefixController.text = first.purOrderNo2Prefix ?? "";
            purchaseOrderNo2Controller.text = first.purchaseOrderNo2 ?? "";
            purOrderNo2SuffixController.text = first.purOrderNo2Suffix ?? "";
            purOrderNo2FormalDigitController.text =
                first.purOrderNo2FormalDigit ?? "";
            quoNoPrefixController.text = first.quoNoPrefix ?? "";
            quotationNoController.text = first.quotationNo ?? "";
            quoNoSuffixController.text = first.quoNoSuffix ?? "";
            quoNoFormalDigitController.text = first.quoNoFormalDigit ?? "";
            quoNo2PrefixController.text = first.quoNo2Prefix ?? "";
            quotationNo2Controller.text = first.quotationNo2 ?? "";
            quoNo2SuffixController.text = first.quoNo2Suffix ?? "";
            quoNo2FormalDigitController.text = first.quotationNo2 ?? "";
            salesNo2PrefixController.text = first.salesNo2Prefix ?? "";
            salesNo2Controller.text = first.salesNo2 ?? "";
            salesNo2SuffixController.text = first.salesNo2Suffix ?? "";
            salesNo2FormalDigitController.text =
                first.salesNo2FormalDigit ?? "";
            salesOrderNoPrefixController.text = first.salesNo2Prefix ?? "";
            salesOrderNoController.text = first.salesOrderNo ?? "";
            salesOrderNoFormalDigitController.text =
                first.salesOrderNoFormalDigit ?? "";
            salesOrderNoSuffixController.text = first.salesOrderNoSuffix ?? "";
          } else {
            // ✅ If empty response, clear fields gracefully
            debugPrint("No number initialization records found.");
            coCodeController.clear();
            finYearCodeController.clear();
            custIdController.clear();
            supIdController.clear();
            // ... you can clear others if needed
          }
        });
      } else {
        setState(() {
      ...
      debugPrint("Error loading serial number: $e\n$st");
      setState(() {
        _getAllLoading = false;
        error = e.toString();
      });
  ...
  Future<void> _submit() async {
    ...
    if (_isEditMode) {
      // EDIT mode
      print(
        serialNumbers!.info!.first.numCode,
      );
        ...
        child: Form(
          ...
          child: LayoutBuilder(builder: (context, constraints) {
            ...
            return Wrap(spacing: 16, runSpacing: 16, children: [
              const SectionRow(title: "Company Master"),
              // const Divider(),
              SizedBox(
                ...
                child: CustomTextField(
                  ...
                  onEditingComplete: () {
                    FocusScope.of(context).requestFocus(finYearCodeFocus);
                  },
                ),
              ),
              ...
              SizedBox(
                ...
                child: CustomTextField(
                  ...
                  textInputAction: TextInputAction.next,
                  onEditingComplete: () {
                    FocusScope.of(context).requestFocus(custIdPrefixFocus);
                  },
                ),
              ),
              const SizedBox(height: 12),
              ...
              const Divider(),
              const SectionRow(title: "Patient Master"),
              SizedBox(
                width: constraints.maxWidth / columns - 20,
                child: CustomTextField(
                  ...
                  isValidate: true,
                  validator: (value) => value == null || value.isEmpty
                      ? "Enter Patient ID Prefix"
                      : null,
                  // focusNode: finYearCodeFocus,
                  textInputAction: TextInputAction.next,
                  onEditingComplete: () {
                    FocusScope.of(context).requestFocus(custIdFocus);
                  },
                ),
              ),
              const SizedBox(height: 12),
              SizedBox(
                ...
                child: CustomTextField(
                  ...
                  textInputAction: TextInputAction.next,
                  onEditingComplete: () {
                    FocusScope.of(context).requestFocus(custIdSuffixFocus);
                  },
                ),
              ),
              const SizedBox(height: 12),
              SizedBox(
                ...
                child: CustomTextField(
                  ...
                  isValidate: true,
                  validator: (value) => value == null || value.isEmpty
                      ? "Enter Patient ID Sufix"
                      : null,
                  // focusNode: finYearCodeFocus,
                  textInputAction: TextInputAction.next,
                  onEditingComplete: () {
                    FocusScope.of(context).requestFocus(custIdFormalDigitFocus);
                  },
                ),
              ),
              const SizedBox(height: 12),
              ...
              const Divider(),
              const SectionRow(title: "Supplier Master"),
              SizedBox(
                width: constraints.maxWidth / columns - 20,
                child: CustomTextField(
              ...
              const SizedBox(height: 12),
              const Divider(),
              const SectionRow(title: "Product Master"),
                ...
                child: CustomTextField(
                  ...
                  onEditingComplete: () {
                    FocusScope.of(context)
                        .requestFocus(productIdFormalDigitFocus);
                  },
                ),
              ),
              const SizedBox(height: 12),
              ...
              const Divider(),
              const SectionRow(title: "Purchase Master"),
              SizedBox(
                width: constraints.maxWidth / columns - 20,
                child: CustomTextField(
                  title: "Purchase No",
              ...
              SizedBox(
                ...
                child: CustomTextField(
                  ...
                  onEditingComplete: () {
                    FocusScope.of(context)
                        .requestFocus(salesNoFormalDigitFocus);
                  },
                ),
              ),
              const SizedBox(height: 20),
              ...
              const Divider(),
              const SectionRow(title: "Purchase 2 Master"),
              SizedBox(
                width: constraints.maxWidth / columns - 20,
                child: CustomTextField(
              ...
              const Divider(),
              const SectionRow(title: "Purchase Order Master"),
              SizedBox(
                width: constraints.maxWidth / columns - 20,
                child: CustomTextField(
              ...
              SizedBox(
                ...
                child: CustomTextField(
                  ...
                  onEditingComplete: () {
                    FocusScope.of(context)
                        .requestFocus(purOrderNoFormalDigitFocus);
                  },
                ),
              ),
              const SizedBox(height: 20),
              ...
              const Divider(),
              const SectionRow(title: "Purchase Order 2 Master"),
              SizedBox(
                width: constraints.maxWidth / columns - 20,
                child: CustomTextField(
              ...
              SizedBox(
                ...
                child: CustomTextField(
                  ...
                  onEditingComplete: () {
                    FocusScope.of(context)
                        .requestFocus(purOrderNo2FormalDigitFocus);
                  },
                ),
              ),
              const SizedBox(height: 20),
              ...
              const Divider(),
              const SectionRow(title: "Quotation Master"),
              SizedBox(
                width: constraints.maxWidth / columns - 20,
                child: CustomTextField(
              ...
              const Divider(),
              const SectionRow(title: "Quotation 2 Master"),
              SizedBox(
                width: constraints.maxWidth / columns - 20,
                child: CustomTextField(
              ...
              const Divider(),
              const SectionRow(title: "Sales 2 Master"),
              SizedBox(
                width: constraints.maxWidth / columns - 20,
                child: CustomTextField(
              ...
              SizedBox(
                ...
                child: CustomTextField(
                  ...
                  onEditingComplete: () {
                    FocusScope.of(context)
                        .requestFocus(salesNo2FormalDigitFocus);
                  },
                ),
              ),
              const SizedBox(height: 20),
              SizedBox(
                ...
                child: CustomTextField(
                  ...
                  onEditingComplete: () {
                    FocusScope.of(context)
                        .requestFocus(salesOrderNoPrefixFocus);
                  },
                ),
              ),
              const SizedBox(height: 20),
              ...
              const Divider(),
              const SectionRow(title: "Sales Order Master"),
              SizedBox(
                width: constraints.maxWidth / columns - 20,
                child: CustomTextField(
              ...
              SizedBox(
                ...
                child: CustomTextField(
                  ...
                  onEditingComplete: () {
                    FocusScope.of(context)
                        .requestFocus(salesOrderNoFormalDigitFocus);
                  },
                ),
              ),
              const SizedBox(height: 20),
              SizedBox(
                ...
                child: CustomTextField(
                  ...
                  onEditingComplete: () {
                    FocusScope.of(context)
                        .requestFocus(salesOrderNoSuffixFocus);
                  },
                ),
              ),
              const SizedBox(height: 20),
