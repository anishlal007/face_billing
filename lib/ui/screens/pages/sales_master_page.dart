...
class SalesMasterPage extends StatefulWidget {
  const SalesMasterPage({super.key});

  @override
  State<SalesMasterPage> createState() =>
      _SalesMasterPageState();
}

class _SalesMasterPageState extends State<SalesMasterPage> {
   Info? editingUnit;
